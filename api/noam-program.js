...
export const NOAM_PROGRAM = {
  ...
  routines: {
    A: { id:'A', label:'Back, Chest & Biceps', locker:'', modes:['heavy','pump'], exercises:[
      ...
      exercise('Dumbbell Shrugs', ['upper-back'], [['כבד',3,'10-15'],['פאמפ',3,'12-15']], 'https://fitnessprogramer.com/wp-content/uploads/2021/04/Dumbbell-Shrug.gif'),
...
export const NOAM_COMMENTS = {
  ...
  'Dumbbell Shrugs':'החזק משקולת בכל יד עם זרועות ישרות. הרם כתפיים ישר לכיוון האוזניים, סחוט שנייה ורד לאט. בלי לגלגל כתפיים.',
